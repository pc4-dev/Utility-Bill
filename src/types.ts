export type Role = 'ADMIN' | 'MANAGER' | 'EA' | 'DATA_ENTRY' | 'GOV_TAX_ENTRY' | 'INSURANCE_ENTRY' | 'VERIFIER' | 'APPROVER' | 'ACCOUNT_MANAGEMENT' | 'ACCOUNT_MANAGER' | 'ACCOUNT_EXECUTIVE_2' | string;
...
export type BillStatus = 'Paid' | 'Pending' | 'Overdue' | 'PAID' | 'PENDING' | 'OVERDUE' | 'Approved' | 'Verified' | 'Payment Initiated' | 'Payment Confirmed' | 'Tally Entry' | 'Rejected' | 'Other';
...
export interface Bill {
  ...
  notes?: string;
  category?: 'utility' | 'telecom' | 'insurance' | 'government_tax' | 'government_compliance' | 'expense' | 'other';
  subcategory?: string;
  locationType?: string;
