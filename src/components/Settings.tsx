    ...
    <div className="space-y-8">
      ...
      <div className="flex gap-6 border-b border-gray-200 dark:border-slate-800 overflow-x-auto pb-1 transition-colors">
        ...
        <button 
          ...
          className={cn("pb-3 px-2 text-sm font-bold transition-all border-b-2 whitespace-nowrap transition-colors", activeTab === 'companies' ? "text-orange-600 border-orange-600" : "text-text-secondary border-transparent hover:text-text-primary")}
        >
          Companies
        </button>
        <button 
