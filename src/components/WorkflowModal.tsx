...
import { X, CheckCircle2, Loader2, AlertCircle, Upload, FileText, File as FileIcon, History, Building2, ShieldCheck, Lock } from 'lucide-react';
...
interface WorkflowModalProps {
  ...
  bill: Bill | null;
  actionType: 'verify' | 'approve' | 'initiate' | 'confirm' | 'tally';
  title?: string;
}
...
export const WorkflowModal: React.FC<WorkflowModalProps> = ({
  ...
  const [customUpiMode, setCustomUpiMode] = useState('');
  ...
  // Add paste listener to handle screenshots from clipboard
  React.useEffect(() => {
    if (!isOpen || (actionType !== 'initiate' && actionType !== 'confirm')) return;
  ...
  const config = {
    ...
    tally: {
      ...
      color: 'indigo',
      buttonText: 'Complete Tally Entry',
    ...
    try {
      await onConfirm(
        ...
        actionType === 'confirm' ? { 
          ...
          upiMode: upiMode === 'Other' ? customUpiMode : upiMode, 
          upiReference, 
        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
          ...
          >
            <div className="p-6 border-b border-gray-50 dark:border-slate-800 flex items-center justify-between bg-gray-50/50 dark:bg-slate-800/50">
              <div className="flex items-center gap-3">
                <div className={cn(
                  ...
                  actionType === 'confirm' ? "bg-purple-50 dark:bg-purple-900/20" :
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <p className="text-xs font-bold text-purple-600 dark:text-purple-400 uppercase tracking-wider">{bill.companyName || 'N/A'}</p>
                    <div className="w-1 h-1 rounded-full bg-gray-300 dark:bg-slate-700" />
                    <p className="text-xs font-medium text-gray-500 dark:text-slate-400">{bill.propertyName}</p>
                  </div>
            ...
            <div className="max-h-[70vh] overflow-y-auto no-scrollbar bg-white dark:bg-slate-900">
              {actionType === 'confirm' && (
                <div className="mx-6 mt-6 p-4 bg-purple-50 dark:bg-purple-900/10 border border-purple-100 dark:border-purple-800/50 rounded-2xl flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="text-[10px] font-bold text-purple-600 uppercase tracking-[0.2em] leading-none mb-1">{bill.utilityType}</p>
                      <p className="text-sm font-black text-gray-900 dark:text-white leading-none mb-1">{bill.propertyName}</p>
                      <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest leading-none">{bill.companyName || 'N/A'}</p>
                    </div>
                  </div>
                        ...
                        <div className="space-y-2">
                          ...
                          {bankName === 'Other' && (
                            <input
                              ...
                              className="w-full px-4 py-2 bg-white dark:bg-slate-900 border border-purple-200 dark:border-purple-900/30 rounded-lg text-sm outline-none focus:ring-1 focus:ring-purple-500"
                              required
                            />
                          )}
                        </div>
                        ...
                        <div className="space-y-2">
                          ...
                          {upiMode === 'Other' && (
                            <input
                              ...
                              value={customUpiMode}
                              onChange={(e) => setCustomUpiMode(e.target.value)}
                              className="w-full px-4 py-2 bg-white dark:bg-slate-900 border border-purple-200 dark:border-purple-900/30 rounded-lg text-sm outline-none focus:ring-1 focus:ring-purple-500"
                              required
                            />
                          )}
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  className={cn(
                    ...
                    actionType === 'confirm' ? "focus:ring-purple-500/10 focus:border-purple-500" :
                      ...
                      {proofFile ? (
                        <div className="flex items-center gap-3">
                          ...
                          <div className="text-left">
                            <p className="text-xs font-black text-gray-900 dark:text-white truncate max-w-[200px]">
                              {proofFile.name === 'image.png' ? 'Pasted Screenshot' : proofFile.name}
                            </p>
                        ...
                        <>
                          ...
                          <p className="text-[10px] text-gray-400 font-medium mt-1">
                            Use Ctrl+V to paste screenshot directly here
                          </p>
                        </>
                      )}
                    </label>
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    actionType === 'confirm' ? "bg-purple-600 hover:bg-purple-700 shadow-purple-500/25" :
              ...
              {actionType === 'tally' && (
                <p className="text-center text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-4">
                  THIS WILL MARK THE TALLY ENTRY AS COMPLETED
                </p>
              )}
            </form>
          </div>
