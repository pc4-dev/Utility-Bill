...
export const DashboardOverview: React.FC<DashboardOverviewProps> = ({ 
  ...
  const statusCards = [
    ...
    { id: 'PAID', label: 'Completed', ...getStat('PAID'), color: 'text-green-600', border: 'border-green-600' },
    { id: 'OVERDUE', label: 'Overdue', ...getStat('OVERDUE'), color: 'text-red-600', border: 'border-red-600' },
    { id: 'PENDING', label: 'In Progress', ...getStat('PENDING'), color: 'text-orange-600', border: 'border-orange-600' },
  ];
